...
| [BVAL-221](https://hibernate.onjira.com/browse/BVAL-221)  |  | [221](/proposals/BVAL-221) | The constraint violation builder cannot put constraint on a top level map key
...
| Issue Id                                                  | Done | Proposal | Description                                        |
| --------------------------------------------------------- | ---- | --------- | --------------------------- |
