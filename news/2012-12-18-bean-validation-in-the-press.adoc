...
The German journal link:http://www.javamagazin.de/[Javamagazin] recently
...
which you can download link:/downloads/javamagazin_2012_10_Einer_fuer_alle_alle_fuer_einen_Bean_Validation_1_1.pdf[here].
Alternatively you can also read the article
link:http://it-republik.de/jaxenter/artikel/Einer-fuer-alle-%96-alle-fuer-einen-Bean-Validation-1.1-5372.html[online].
