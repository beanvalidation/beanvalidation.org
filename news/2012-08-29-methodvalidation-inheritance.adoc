...
:awestruct-tags: [ "feedback-needed" ]
...
link:http://beanvalidation.org/1.1/spec/#d0e2147[method validation], that is the validation
of method parameters and return values using constraint annotations. Bean Validation 1.1
link:http://beanvalidation.org/news/2012/03/13/release-1-1-edr1/[early draft 1] lays the
ground for this, and right now we're tackling some
link:https://hibernate.atlassian.net/browse/BVAL-272[advanced questions] still open in that area
(btw. if you haven't yet tried out the
link:http://in.relation.to/Bloggers/FirstAlphaReleaseOfHibernateValidator5[reference implementation]
of ED1, this is the perfect time to do so and give us your feedback).

== The problem

One question the EG currently is link:http://lists.jboss.org/pipermail/beanvalidation-dev/2012-August/000504.html[discussing]
...
link:http://beanvalidation.org/1.1/spec/#d0e2429[draft document] for all the gory details):
...
link:http://en.wikipedia.org/wiki/Liskov_substitution_principle[behavioral sub-typing], which
...
link:http://research.microsoft.com/en-us/projects/contracts/[is employed] by other
...
to the link:https://lists.jboss.org/mailman/listinfo/beanvalidation-dev[mailing list] or
participating in this link:http://www.doodle.com/qp78u6mqzetuas7p[Doodle vote]. Which use cases
