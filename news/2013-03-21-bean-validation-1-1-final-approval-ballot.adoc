...
* link:http://beanvalidation.org/1.1/spec/1.1.0.cr3/[the specification]
* link:http://www.hibernate.org/subprojects/validator/download[Hibernate Validator (the RI)]
* link:http://www.hibernate.org/subprojects/validator/download[the TCK]
