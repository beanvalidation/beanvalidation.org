...
request for the [Jakarta Validation API](https://github.com/jakartaee/validation)
...
[TCK](https://github.com/jakartaee/validation-tck) and send a pull request for each. Easy :)
